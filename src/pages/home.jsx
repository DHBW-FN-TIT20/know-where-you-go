...
const HomePage = () => (
    <Page name="home">
        ...
        <Navbar large sliding={false}>
            ...
            <NavTitle sliding>Know Where You Go</NavTitle>
            <NavRight>
                <Link iconIos="f7:menu" iconAurora="f7:menu" iconMd="material:menu" panelOpen="right" />
            </NavRight>
            <NavTitleLarge>Know Where You Go</NavTitleLarge>
        </Navbar>

        {/* Page content */}
        <Block strong>
            <p>
                This is an example of tabs-layout application. The main point of such tabbed layout is that each tab
                contains independent view with its own routing and navigation.
            </p>

            <p>
                Each tab/view may have different layout, different navbar type (dynamic, fixed or static) or without
                navbar like this tab.
            </p>
        </Block>
